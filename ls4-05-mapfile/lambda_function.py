...
def lambda_handler(event, context):
    ...
    xmin = str(int(float(mins.split(" ")[0])) - 30)
    ymin = str(int(float(mins.split(" ")[1])) - 30)
    xmax = str(int(float(maxs.split(" ")[0])) + 30)
    ymax = str(int(float(maxs.split(" ")[1])) + 30)
